...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
		...
		function init(){
			doAjax('<%=request.getContextPath() + "/GetList"%>',"type=clerk",setStore);
		}
		...
		function setStore(data, status){
                ...
                for(var i=0;i<data.length;i++){
                    //a.append('<div class="col-xs-6 col-sm-3 placeholder"> <img src='+pat+'/page/images/clerk1.jpg  class="img-responsive" alt="Generic placeholder thumbnail"> <h4><a href='+pat + '/page/jsps/Admin_Clerk.jsp?id='+data[i].id+'>'+data[i].name+'</a></h4> <span class="text-muted">Something else</span> </div>');
                	a.append('<tr><td>'+data[i].id+'</td><td><a href="'+pat+'/page/jsps/Admin_Clerk.jsp?id='+data[i].id+'" name="'+data[i].id+'">'+data[i].name+'</a></td><td>'+data[i].sex+'</td><td><a href="'+pat+'/page/jsps/Admin_Store.jsp?id='+data[i].storeid+'" name="'+data[i].id+'">'+data[i].store+'</a></td><td><a href="'+pat+'/page/jsps/Admin_Clerk.jsp?id='+data[i].id+'" name="'+data[i].id+'">详细</a></td><td><a onclick="btndelete(this.name)" name="'+data[i].id+'">删除</a></td></tr>');
                }
        }
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar" style="padding-top: 100px;">
          ...
          <ul class="nav nav-sidebar">
			<li class="active"><a href="<%=request.getContextPath() + "/page/jsps/Admin_Clerklist.jsp"%>">职员列表</a></li>
				...
				<table class="table table-striped" style="width:100%;">
                	<thead>
                    	<tr>
                            ...
                            <th class="thcenter" >性别</th>
                            <th class="thcenter" >所属商店</th>
