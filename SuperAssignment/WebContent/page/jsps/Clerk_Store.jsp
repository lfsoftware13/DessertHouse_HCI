...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
		...
		function setInf(data, status){
                ...
                //a.append('<li><div class="sb-info"><p class="sbi-l">商店编号：</p><p class="sbi-m">'+data[0].id+'</p></div></li><li><div class="sb-info"><p class="sbi-l">商店名 ：</p><p class="sbi-m">'+data[0].name+'</p></div></li><li><div class="sb-info"><p class="sbi-l">商店地址：</p><p class="sbi-m">'+data[0].place+'</p></div></li>');
                $("#storeid").text(data[0].id);
                $("#store").text(data[0].name);
                $("#address").text(data[0].place);
            }
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="padding-top: 100px;">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<%=request.getContextPath() + "/page/jsps/Clerk_Store.jsp?id="+session.getAttribute("id")%>">商店信息</a></li>
            ...
            <ul id="content">
                ...
                <li>
                	<div class="sb-info">
                		...
                		<p class="sbi-m" id="storeid"></p>
                	</div>
                </li>
                <li>
                	<div class="sb-info">
                		<p class="sbi-l">商店名 ：</p>
                		<p class="sbi-m" id="store"></p>
                	</div>
                </li>
                <li>
                	<div class="sb-info"><p class="sbi-l">商店地址：</p>
                		<p class="sbi-m" id="address"></p>
                	</div>
                </li>
