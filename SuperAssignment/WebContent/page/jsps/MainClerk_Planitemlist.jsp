    ...
    <script type="text/javascript">
        ...
        function setPlanitemlist(data, status){
                ...
                for(var i=0;i<data.length;i++){
					...
					a.append('<tr><td>'+data[i].id+'</td><td>'+data[i].productid+'</td><td>'+data[i].product+'</td><td>'+data[i].number+'</td><td>'+data[i].price+'</td><td><a href="'+pat+'/page/jsps/MainClerk_Planitem.jsp?id='+data[i].id+'">修改</a></td><td><a onclick="btndelete(this.name)" name="'+data[i].id+'">删除</a></td></tr>');
                }
            }
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">分项计划</h1>
                  ...
                  <a href="<%=request.getContextPath() %>/page/jsps/MainClerk_PlanitemAdd.jsp?id=<%=request.getParameter("id")%>"><button class="btn" onclick="add()" style="margin-left:20px;background-color:#428bca;color:white;">添加分项计划</button></a>
