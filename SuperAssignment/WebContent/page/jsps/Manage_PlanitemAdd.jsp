...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        ...
        function init(){
        	jQuery("#showplanid").text("<%=request.getParameter("id")%>");
        ...
        function setProductlist(data, status){
        	...
        	if(jQuery("#select02 option").size()>0){
        		jQuery("#showproductid").text(jQuery("#select02 option:first").val());
        	}
        }
        ...
        function save(){
        	var j={'type':'add','planid':'<%=request.getParameter("id")%>','productid':jQuery("#showproductid").text(),'number':jQuery("#shownumber").val(),'price':jQuery("#showprice").val()};
...
<!-- class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" -->
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div>
          <h1 class="page-header">添加分项计划</h1>
          </div>
...
<!-- <div class="security-right"> -->
        <div class="sr-b" style="margin-left: auto;margin-right: auto;">
            <ul id="contentul">
            	<li>
                    <div class="sb-info">
                        <p class="sbi-l">所属计划：</p>
                        <p class="sbi-m" id="showplanid"></p>
                    </div>
                </li>
                <li>
                    <div class="sb-info">
                ...
                <li>
                    <div class="sb-info">
                            ...
                            <div class="sbi-m">
                                <button onclick="save()" class="btn" id="btnconfirm" style="background-color:#428bca;color:white;">确定</button>
                            </div>
                    </div>
                </li>
