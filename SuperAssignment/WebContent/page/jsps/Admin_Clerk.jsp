...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        ...
        function setClerkInf(data, status){
            ...
            $("#showaccount").text(data[0].account);
            $("#showname").val(data[0].name);
            
            var b=jQuery("#select01");
            var c=jQuery("#select02");
            
            //b.find("option[text='"+data[0].sex+"']").attr("selected",true);   
            b.val(data[0].sex);
            c.val(data[0].storeid);
        ...
        function save(){
        	var j={'type':'update','id':$("#showid").text(),'name':$("#showname").val(),'sex':$("#select01").val(),'storeid':$("#select02").val()};
            ...
            <ul id="content">
               ...
               <li>
               	<div class="sb-info">
               		...
               		<div class="sbi-m">
               			<select id="select02" style="height:25px;"></select>
               		</div>
               	</div>
               </li>
               <li>
