...
#year,#month{padding-right:10px;}
    ...
    <script type="text/javascript">
        ...
        function init(){
        	...
        	doAjax("<%=request.getContextPath() + "/PlanInf"%>","type=plan&id=<%=request.getParameter("id")%>",setPlan);
        	//doAjax("<%=request.getContextPath() + "/GetList"%>","type=store",setStorelist);
        }
        ...
        function save(){
        	...
        	var j={'type':'update','id':jQuery("#showid").text(),'start':a,'end':b,'storeid':jQuery("#showstoreid").text()};
       ...
       -->   
          ...
          <div class="row placeholders" id="content">
          	<div class="sr-b" style="margin-left: auto;margin-right: auto;">
                ...
                <li>
                    <div class="sb-info">
                        <p class="sbi-l">计划状态：</p>
                        <p class="sbi-m" id="showstatus"></p>
                    </div>
                </li>
                <li>
                    <div class="sb-info">
