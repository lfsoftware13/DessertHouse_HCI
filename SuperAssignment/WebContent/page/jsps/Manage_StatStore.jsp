...
//            $("#datelist").val(c);
        ...
        function initStat(){
        	...
        	var myChart = echarts.init(document.getElementById('stattotal'));
        	// 显示标题，图例和空的坐标轴
        	myChart.setOption({
        	    title: {
        	        text: '商店统计'
        ...
        function refresh(){
        	var j={'type':'store','storeid':$("#selectstore").val(),'time':$("#datelist").val()};
        ...
        function setStat(data,status){
        	...
        	var myChart1 = echarts.init(document.getElementById('stattotal'));
        	// 显示标题，图例和空的坐标轴
        	myChart1.setOption({
        	    title: {
        	        text: '销售统计'
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="padding-top: 50px;">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<%=request.getContextPath() + "/page/jsps/Manage_StatStore.jsp"%>">店铺统计</a></li>
...
<!-- class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" -->
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">销量统计</h1>
        	...
        	<label style="margin-left: 10px;font-size:15px;">选择商店:</label>
        	<select id="selectstore" onchange="refresh()" style="width: 100px;height:25px;margin-left: 20px;">
        	</select>
...
<!-- <div class="security-right"> -->
    ...
    <!-- </div> -->
        ...
        <div class="sr-b" style="margin-left: auto;margin-right: auto;">
            ...
            <div id="stattotal" class="stat"></div>
