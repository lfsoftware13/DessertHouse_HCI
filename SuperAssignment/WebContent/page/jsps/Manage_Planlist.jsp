        ...
        function setPlanlist(data, status){
                ...
                for(var i=0;i<data.length;i++){
                	if(data[i].status=="已通过"){
    					a.append('<tr><td>'+data[i].id+'</td><td>'+data[i].start+'</td><td>'+data[i].end+'</td><td><a href="'+pat+'/page/jsps/Manage_Store.jsp?id='+data[i].storeid+'">'+data[i].storeid+'</a></td><td><a href="'+pat+'/page/jsps/Manage_Store.jsp?id='+data[i].storeid+'">'+data[i].store+'</a></td><td>'+data[i].status+'</td><td><a href="'+pat+'/page/jsps/Manage_Planitemlist.jsp?id='+data[i].id+'&status='+data[i].status+'">详细</a></td><td><a>-</a></td><td><a name="'+data[i].id+'">-</a></td></tr>');
                	}else{
    					a.append('<tr><td>'+data[i].id+'</td><td>'+data[i].start+'</td><td>'+data[i].end+'</td><td><a href="'+pat+'/page/jsps/Manage_Store.jsp?id='+data[i].storeid+'">'+data[i].storeid+'</a></td><td><a href="'+pat+'/page/jsps/Manage_Store.jsp?id='+data[i].storeid+'">'+data[i].store+'</a></td><td>'+data[i].status+'</td><td><a href="'+pat+'/page/jsps/Manage_Planitemlist.jsp?id='+data[i].id+'&status='+data[i].status+'">详细</a></td><td><a href="'+pat+'/page/jsps/Manage_Plan.jsp?id='+data[i].id+'">修改</a></td><td><a onclick="btndelete(this.name)" name="'+data[i].id+'">删除</a></td></tr>');
                	}
                }
            }
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header">计划列表</h1>
            ...
            <a href="<%=request.getContextPath()%>/page/jsps/Manage_PlanAdd.jsp"><button class="btn" onclick="<%=request.getContextPath()%>/page/jsps/MainClerk_PlanAdd.jsp" style="margin-left:20px;background-color:#428bca;color:white;">添加计划</button></a>
