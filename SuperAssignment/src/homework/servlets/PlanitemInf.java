...
/**
 * Servlet implementation class PlanitemInf
 */
@WebServlet("/PlanitemInf")
public class PlanitemInf extends HttpServlet {
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		PlanItem item=planService.findPlanItemById(request.getParameter("id"));
		
		JsonConfig jsonConfig = new JsonConfig();
        jsonConfig.registerJsonValueProcessor(Date.class , new JsonDateValueProcessor());
		
        JSONArray array=JSONArray.fromObject(item,jsonConfig);
